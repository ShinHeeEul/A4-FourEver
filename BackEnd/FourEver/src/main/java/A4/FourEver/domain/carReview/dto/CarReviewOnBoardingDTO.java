    ...
    private final CarReviewSimpleDTO[] carReviewSimpleDTOS = {
            CarReviewSimpleDTO.builder()
                    ...
                    .exColorInfoDTO(ExColorInfoDTO.builder()
                            .name("어비스 블랙펄")
                            .color_image("http://hyundaimycar.store/ex_color/11.png")
                            .rotation_image("http://hyundaimycar.store/rotation/abyss/1.png")
                            .build())
                    .inColorInfoDTO(InColorInfoDTO.builder()
                            .name("퀄팅천연(블랙)")
                            .color_image("http://hyundaimycar.store/in_color/17-1.png")
                            .build())
                    .build(),
            CarReviewSimpleDTO.builder()
                    .car_name("팰리세이드")
                    ...
                    .exColorInfoDTO(ExColorInfoDTO.builder()
                            .name("쉬머링 실버 메탈릭")
                            .color_image("http://hyundaimycar.store/ex_color/12.png")
                            .rotation_image("http://hyundaimycar.store/rotation/blue/1.png")
                            .build())
                    .inColorInfoDTO(InColorInfoDTO.builder()
                            .name("퀄팅천연(블랙)")
                            .color_image("http://hyundaimycar.store/in_color/17-1.png")
            ...
            CarReviewSimpleDTO.builder()
                    ...
                    .exColorInfoDTO(ExColorInfoDTO.builder()
                            .name("크리미 화이트 펄")
                            .color_image("http://hyundaimycar.store/ex_color/16.png")
                            .rotation_image("http://hyundaimycar.store/rotation/white/1.png")
                            .build())
                    .inColorInfoDTO(InColorInfoDTO.builder()
                            .name("쿨그레이")
                            .color_image("http://hyundaimycar.store/in_color/18-1.png")
                            .build())
                    .build(),
    };

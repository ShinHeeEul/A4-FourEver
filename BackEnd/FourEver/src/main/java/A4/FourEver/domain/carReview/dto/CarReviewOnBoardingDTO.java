    ...
    private final CarReviewSimpleDTO[] carReviewSimpleDTOS = {
            CarReviewSimpleDTO.builder()
                    ...
                    .exColorInfoDTO(ExColorInfoDTO.builder()
                            ...
                            .rotation_image("https://s3.ap-northeast-2.amazonaws.com/hyundaimycar.store/rotation/abyss/1.webp")
                            .build())
            ...
            CarReviewSimpleDTO.builder()
                    ...
                    .exColorInfoDTO(ExColorInfoDTO.builder()
                            ...
                            .rotation_image("https://s3.ap-northeast-2.amazonaws.com/hyundaimycar.store/rotation/blue/1.webp")
                            .build())
                    .inColorInfoDTO(InColorInfoDTO.builder()
                            .name("퀄팅천연(블랙)")
                            .color_image("https://s3.ap-northeast-2.amazonaws.com/hyundaimycar.store/in_color/17-1.png")
            ...
            CarReviewSimpleDTO.builder()
                    ...
                    .exColorInfoDTO(ExColorInfoDTO.builder()
                            ...
                            .rotation_image("https://s3.ap-northeast-2.amazonaws.com/hyundaimycar.store/rotation/white/1.webp")
                            .build())
                    .inColorInfoDTO(InColorInfoDTO.builder()
                            .name("쿨그레이")

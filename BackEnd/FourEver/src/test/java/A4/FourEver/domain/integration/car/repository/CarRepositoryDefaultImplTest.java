package A4.FourEver.domain.integration.car.repository;

import A4.FourEver.domain.integration.IntegrationBaseTest;

class CarRepositoryDefaultImplTest extends IntegrationBaseTest {
//
//    private final CarRepository carRepository;
//
//    @Autowired
//    CarRepositoryDefaultImplTest(CarRepository carRepository) {
//        this.carRepository = carRepository;
//    }
//
//    @Test
//    @DisplayName("(통합) CarRepository 에서 차량의 아이디로 트림 정보가 성공적으로 조회 되어야한다.")
...
//                .trimInfoDTOs(Set.of(trimInfo, trimInfo2, trimInfo3, trimInfo4))

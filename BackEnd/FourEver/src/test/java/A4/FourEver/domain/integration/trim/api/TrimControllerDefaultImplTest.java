package A4.FourEver.domain.integration.trim.api;

import A4.FourEver.domain.integration.IntegrationBaseTest;

class TrimControllerDefaultImplTest extends IntegrationBaseTest {
//
//    private final TrimController trimController;
//
//    @Autowired
//    TrimControllerDefaultImplTest(TrimController trimController) {
//        this.trimController = trimController;
//    }
//
//    @Test
//    @DisplayName("(통합) TrimController 에서 트림의 아이디로 내외장 생상 정보가 성공적으로 조회 되어야한다.")
...
//
//        // When
//        TrimColorsAndTagsDTO result = trimController.getTrimColorsAndTagsById(trimId);
//
//        // Then

package A4.FourEver.domain.integration.car.application;

import A4.FourEver.domain.integration.IntegrationBaseTest;

class CarServiceDefaultImplTest extends IntegrationBaseTest {
//
//    private final CarService carService;
//
//    @Autowired
//    public CarServiceDefaultImplTest(CarService carService) {
//        this.carService = carService;
//    }
//
//    @Test
//    @DisplayName("(통합) CarService 에서 차량의 아이디로 트림 정보가 성공적으로 조회 되어야한다.")

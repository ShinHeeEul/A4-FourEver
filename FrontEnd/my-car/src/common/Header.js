...
const AutoSaveWrap = styled.div`
  ...
  flex-shrink: 0;
`;
const AutoSaveText = styled.span`
  ${Body4Medium};
  color: ${palette.DarkGray};
`;

const HyundaiLogo = styled.div`
  margin-top: 3px;
  cursor: pointer;
`;
    ...
    <HeaderDiv>
      <HeaderElements>
        ...
        <svg
          ...
          fill="none"
        >
          <path d="M0.5 0V8.5" stroke="#232323" />
        </svg>
        <HeaderPageText>{headerPageName[0]}</HeaderPageText>
      </HeaderElements>
      <HeaderElements>
        <AutoSaveWrap>
          <AutoSaveText>자동 저장중</AutoSaveText>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="10"
            height="10"
        ...
        <ToCarivingBtn onClick={() => showAlert(setShowCommonAlert)}>
          ...
          >
            <path
              d="M19.8774 12.9082L18.5596 7.68921C18.507 7.48091 18.3196 7.33496 18.1048 7.33496H7.34293C7.12809 7.33496 6.94071 7.48091 6.88812 7.68921L5.57031 12.9082"
              stroke="#E4DCD3"
              strokeWidth="1.55111"
            />
            <path
              d="M8.78147 15.9273C8.78147 16.3895 8.40094 16.7773 7.91523 16.7773C7.42953 16.7773 7.04899 16.3895 7.04899 15.9273C7.04899 15.4651 7.42953 15.0773 7.91523 15.0773C8.40094 15.0773 8.78147 15.4651 8.78147 15.9273Z"
              stroke="#E4DCD3"
              strokeWidth="1.55111"
            />
            <path
              d="M18.1604 15.9273C18.1604 16.3895 17.7798 16.7773 17.2941 16.7773C16.8084 16.7773 16.4279 16.3895 16.4279 15.9273C16.4279 15.4651 16.8084 15.0773 17.2941 15.0773C17.7798 15.0773 18.1604 15.4651 18.1604 15.9273Z"
              stroke="#E4DCD3"
              strokeWidth="1.55111"
            />
            <path
              d="M5.56724 21.7321H6.99163C7.62984 21.7321 8.1472 21.2147 8.1472 20.5765C8.1472 19.9383 8.66457 19.4209 9.30278 19.4209H16.3733C17.0115 19.4209 17.5289 19.9383 17.5289 20.5765C17.5289 21.2147 18.0463 21.7321 18.6845 21.7321H19.4052H20.1088C20.7565 21.7321 21.2816 21.207 21.2816 20.5594V14.3505C21.2816 13.9724 21.0993 13.6175 20.792 13.3973L20.4151 13.1272C20.216 12.9845 19.9771 12.9077 19.732 12.9077H5.94406C5.69902 12.9077 5.46013 12.9845 5.26095 13.1272L4.88413 13.3973C4.57681 13.6175 4.39453 13.9724 4.39453 14.3505V20.5594C4.39453 21.207 4.91957 21.7321 5.56724 21.7321Z"
              stroke="#E4DCD3"
              strokeWidth="1.55111"
            />
            <path
              d="M1 21.7327V8.52302C1 7.64842 1.49047 6.8477 2.2696 6.45035L11.8694 1.55442C12.5501 1.20723 13.358 1.21647 14.0306 1.57912L23.0442 6.43873C23.7972 6.84473 24.2667 7.63122 24.2667 8.48671V21.7327"
              stroke="#E4DCD3"
              strokeWidth="1.55111"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <ToCarivingBtnText>아카이빙</ToCarivingBtnText>
        </ToCarivingBtn>
      </HeaderElements>
    </HeaderDiv>
  );
